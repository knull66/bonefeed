...
enum L10n {
    ...
    private static let en: [String: String] = [
        ...
        // VIP Signals
        "vip.status": "Bonefeed VIP",
        "vip.statusDetail": "Tight signal desk active — still watch-only.",
        "vip.title": "VIP Signals",
        "vip.blurb": "Faster market pings (±2.5% pump/dump, fee desk). Never trades for you.",
        "vip.1": "Tight desk: ±2.5% pump / dump on your watchlist",
        "vip.2": "Earlier BTC fee warnings (25 sat/vB)",
        "vip.3": "Shorter alert cooldown (15 min)",
        "vip.4": "Includes everything in Pro",
        "vip.5": "Watch-only — alerts you act on",
        "vip.buy": "Buy Bonefeed VIP",
        "vip.purchasing": "Opening App Store…",
        "vip.unlocked": "VIP Signals unlocked. Desk is live.",
        "vip.purchaseFailed": "VIP purchase didn’t complete.",
        "vip.unlockDebug": "Pre-release: Unlock VIP",
        "vip.unlockedDebug": "VIP unlocked (pre-release).",
        "vip.deskToggle": "VIP tight desk",
        "vip.deskHelp": "When on: ±2.5% moves + fee desk. When off: use Free/Pro thresholds below.",
...
""",
    ...
    private static let es: [String: String] = [
        ...
        "vip.status": "Bonefeed VIP",
        "vip.statusDetail": "Desk de señales activas — sigue siendo watch-only.",
        "vip.title": "VIP Signals",
        "vip.blurb": "Pings más rápidos (±2.5% pump/dump, fees). Nunca opera por ti.",
        "vip.1": "Desk tight: ±2.5% pump / dump en tu watchlist",
        "vip.2": "Avisos de fee BTC antes (25 sat/vB)",
        "vip.3": "Cooldown de alertas más corto (15 min)",
        "vip.4": "Incluye todo Pro",
        "vip.5": "Watch-only — tú decides",
        "vip.buy": "Comprar Bonefeed VIP",
        "vip.purchasing": "Abriendo App Store…",
        "vip.unlocked": "VIP Signals desbloqueado. Desk activo.",
        "vip.purchaseFailed": "La compra VIP no se completó.",
        "vip.unlockDebug": "Pre-release: Desbloquear VIP",
        "vip.unlockedDebug": "VIP desbloqueado (pre-release).",
        "vip.deskToggle": "Desk VIP tight",
