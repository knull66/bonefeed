...
enum L10n {
    ...
    private static let en: [String: String] = [
        ...
        "pro.gate.binance": "Binance Spot / Earn needs Bonefeed Pro.",
...
""",
        ...
        "alerts.from": "From",
        "alerts.to": "to",
        "alerts.quietHint": "Mute pump/dump/fee/earn/health. Deposits still notify.",
        ...
        "panel.logHint": "Deposits & earn events appear here.",
    ...
    private static let es: [String: String] = [
        ...
        "pro.gate.binance": "Binance Spot / Earn requiere Bonefeed Pro.",
...
""",
        ...
        "alerts.from": "Desde",
        "alerts.to": "hasta",
        "alerts.quietHint": "Mute pump/dump/fee/earn/health. Los depósitos sí.",
        "alerts.aave": "Aave (ETH)",
        ...
        "panel.marketsEmpty": "EMPTY · ⚙ Radar watchlist",
        "panel.logEmpty": "LOG EMPTY",
        "panel.logHint": "Depósitos y eventos Earn aparecen aquí.",
        "panel.simulate": "> SIMULATE_DEPOSIT",
        "panel.clearLog": "> CLEAR_LOG",
        "panel.noEarn": "NO EARN POSITIONS",
        "panel.noApi": "NO API  →  ⚙ SETTINGS",
